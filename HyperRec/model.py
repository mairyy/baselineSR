...
class NeuralSeqRecommender(object):
    ...
    def _build(self):
        ...
        self.item_embedding = item_embedding = tf.get_variable('item_embedding', \
                                ...
                                dtype=tf.float32, \
                                regularizer=tf.keras.regularizers.L2(l2=self.args.l2_reg), \
        ...
        ct_vec_batch = tf.tile(ct_vec_last, [12101, 1])
        ...
        self.test_item_batch_dy = tf.placeholder(tf.int32, shape=(None, 12101), name='test_item_batch_dy')
        ...
        self.test_logits_batch = tf.transpose(tf.reshape(self.test_logits_batch, [12101, tf.shape(self.inp)[0]]))
